                                ...
                                <form action="proses_update_pembelian.php" method="post">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="JenisKelamin" class="form-control" value="<?= $d['JenisKelamin']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
                                        ...
                                        <div class="form-group">
                                            <label>Kota</label>
                                            <input type="text" name="Kota" class="form-control" value="<?= $d['Kota']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>KodePost</label>
                                            <input type="text" name="KodePost" class="form-control" value="<?= $d['KodePost']; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>NoTelp</label>
        ...
        <form action="proses_pembelian.php" method="post">
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="Tanggal" value="<?= date("Y-m-d") ?>" class="form-control">
                </div>
                <div class="form-group">
                    <label>Kota</label>
